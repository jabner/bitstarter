...
var buildFile = function(filename, checksFile) {
...
if(require.main == module) {
	...
	.option('-u, --url <html_page>', 'Path to webpage', HTMLPAGE_DEFAULT)
        .parse(process.argv);
    var response2console = buildFile(HTMLFILE_DEFAULT, program.checks);
